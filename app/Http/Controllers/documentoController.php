...
class documentoController extends AppBaseController
{
    ...
    /*    $link='https://elsiglo.com.ve/internasucesos/';
      ...
      /*$link='https://diariolavoz.net/sucesos/';
        ...
        //dd();
        $this->getDocumentosDB($request->input('k'));
    ...
    public function insertMatrizkmeans($k){
   ...
   /*$relevancia_array = array(
        ...
        return $this->kMeans($relevancia_array, $k);
    }
